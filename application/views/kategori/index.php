	...
	<div class="main">
		<div class="container">
			...
			<div class="nav-buttons">
				<a href="<?= site_url('produk') ?>" class="btn-nav">Produk</a>
				<a href="<?= site_url('kategori') ?>" class="btn-nav active">Kategori</a>
				<a href="<?= site_url('status') ?>" class="btn-nav">Status</a>
			</div>
			<!-- Halaman Produk -->
			<div id="page-kategori" class="page active">
				<div class="panel">
					...
					<div class="panel-body">
						<div class="action-bar">
							<a href="<?php echo site_url('kategori/tambah') ?>" class="btn tambah">Tambah Kategori</a>
						</div>
						<table class="table table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td width="250">
										<a href="<?php echo site_url('kategori/editkategori/'.$data->id_kategori) ?>" class="btn edit" role="button">Edit</a>
										<a href="javascript:void(0)" onclick="confirmDelete('<?php echo site_url('kategori/hapuskategori/'.$data->id_kategori) ?>')" class="btn hapus" role="button">Hapus</a>
									</td>
								</tr>
							<?php endforeach; ?>
						</tbody>
