	...
	<div class="main">
		<div class="container">
			...
			<div class="nav-buttons">
				...
				<a href="<?= site_url('status') ?>" class="btn-nav active">Status</a>
			</div>
			<!-- Halaman Produk -->
				...
				<div class="panel">
					...
					<div class="panel-body">
						<div class="action-bar">
							<a href="<?php echo site_url('status/tambah') ?>" class="btn tambah">Tambah Status</a>
						</div>
						<table class="table table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td width="250">
										<a href="<?php echo site_url('status/editstatus/'.$data->id_status) ?>" class="btn edit" role="button">Edit</a>
										<a href="javascript:void(0)" onclick="confirmDelete('<?php echo site_url('status/hapusstatus/'.$data->id_status) ?>')" class="btn hapus" role="button">Hapus</a>
									</td>
								</tr>
							<?php endforeach; ?>
						</tbody>
